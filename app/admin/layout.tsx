    ...
    <div className="flex min-h-screen bg-slate-100 dark:bg-[#070e1a] text-slate-900 dark:text-slate-100">
      ...
      >
        ...
        <div className="border-t border-slate-200 p-4 space-y-3 dark:border-slate-800">
          ...
          <div className="flex items-center justify-between rounded-xl bg-slate-100 px-3 py-2 text-xs dark:bg-slate-800/80">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="font-bold text-slate-900 dark:text-white">Admin Staff</p>
